...
namespace BoolExprNet.Internal
{
    ...
    /// <summary>
    /// Provides a managed iterator over the CF_ITER type.
    /// </summary>
    class _CofactorIter : ManagedRef, IEnumerator<Expression>
    {
        ...
        internal _CofactorIter(IntPtr ptr) :
            base(ptr)
        {
        ...
        {
            Native.boolexpr_CofactorIter_del(ptr);
        }
